      ...
      <StyleProvider hashPriority='high'>
        ...
        <div className='w-full md:p-4'>
          <div className='w-full'>
            <img src='banner.jpg' className='object-cover w-full' />
          </div>
        </div>
        <section className='bg-white py-8'>
          <div className='container mx-auto flex items-center flex-wrap pt-4 pb-12'>
            ...
            <Row gutter={[16, 16]}>
              <Col span={screens.xs ? 24 : screens.lg ? 6 : screens.md ? 8 : 12}>
                <Card
                  hoverable
                  cover={
                    <img
                      alt='example'
                      src='https://ibongcuoi.vn/wp-content/uploads/2020/08/H71662b9370bb4174ba6a2696f0151199J.jpg'
                    />
                  }
                >
                  <Meta
            ...
            <Affix offsetBottom={10} onChange={(affixed) => console.log(affixed)} style={{ marginTop: '10px' }}>
              <Button
                className='p-4'
                href='https://zalo.me/0787302468'
                type='primary'
                icon={<PhoneFilled style={{ color: 'red' }} />}
              >
                CALL 0787302468
              </Button>
            </Affix>
        ...
        <footer className='bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600'>
          ...
          <ul className='flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0'>
            ...
            <li>
              <svg className='mr-2 -ml-1 w-10 h-3' viewBox='0 0 660 203' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <path
